...
1. Fork the [repository](https://github.com/gchhablani/financial-sentiment-analysis) by clicking on the 'Fork' button on the repository's page. This creates a copy of the code under your GitHub user account.
...
2. Clone your fork to your local disk, and add the base repository as a remote:
	...
	cd super-pixels
	git remote add upstream https://github.com/gchhablani/financial-sentiment-analysis.git
	```
...
6. Test your code- To test your code locally, activate the environment using the following command:
	...
	```bash
	source finsent-env/bin/activate
	```
